...
export default function AdminConfigPage() {
 ...
 {config && (
 <div className="page-card !mb-0 p-10 bg-theme-primary border-none shadow-[0_30px_60px_-15px_rgba(0,0,0,0.3)] relative overflow-hidden group">
 <div className="absolute top-0 right-0 p-10 opacity-5 group-hover:scale-110 transition-transform">
 <Settings size={120} strokeWidth={1} className="text-white dark:text-theme-fg" />
 </div>
 
 <div className="flex items-center gap-3 mb-10 relative z-10">
 <div className="w-2 h-2 rounded-full bg-sky-500 animate-pulse" />
 <h3 className="text-[10px] font-black text-white dark:text-theme-fg uppercase tracking-[0.4em]">Aggregated Manifest — Live System State</h3>
 </div>
 ...
 { l: "Archetype Stage", v: config.company_stage, c: "text-white dark:text-theme-fg" },
 { l: "Yield Factor", v: `${config.profit_percentage}%`, c: "text-emerald-400 dark:text-emerald-600" },
 { l: "Cycle Registry", v: `#${config.current_claim_cycle}`, c: "text-white dark:text-theme-fg" },
 { l: "Lockdown Epoch", v: `${config.vesting_days} Days`, c: "text-amber-400 dark:text-amber-600" },
 ].map(st => (
 <div key={st.l} className="space-y-2">
 <p className="text-[8px] font-black text-white/40 dark:text-theme-fg/40 uppercase tracking-[0.2em]">{st.l}</p>
