                ...
                <div className="p-6 bg-[hsl(var(--surface-raised))] border-b border-default flex justify-between items-start">
                   <div className="flex items-center gap-4">
                      <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                         ...
                         sub.status === 'inactive' ? 'bg-slate-500/10 text-slate-500' : 'bg-sky-500/10 text-sky-600'
                      }`}>
                ...
                <div className="p-8 space-y-6">
                   ...
                   <div className="flex justify-between items-center text-[8px] font-black uppercase tracking-[0.4em] text-muted opacity-60">
                      ...
                      <div className="flex gap-1 items-center">
                         <div className={`w-1.5 h-1.5 rounded-full ${sub.status === 'active' ? 'bg-emerald-500' : sub.status === 'expiring' ? 'bg-amber-500 animate-pulse' : 'bg-slate-400'}`} />
                         {sub.status}
                      </div>
                   </div>
                </div>
