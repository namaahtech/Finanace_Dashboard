...
export default function AnalyticsPage() {
 ...
 <div className="page-card !mb-0 p-0 border-none shadow-[0_40px_80px_-15px_rgba(0,0,0,0.3)] bg-theme-primary rounded-[2.5rem] overflow-hidden group">
 <div className="p-10 border-b border-white/5 flex justify-between items-center">
 <div className="flex items-center gap-4">
 <div className="w-12 h-12 rounded-2xl bg-theme-surface/80 flex items-center justify-center text-white">
 ...
 <div className="aspect-video w-full bg-theme-surface/80[0.02] flex items-center justify-center relative group-hover:bg-theme-surface/80[0.04] transition-colors">
