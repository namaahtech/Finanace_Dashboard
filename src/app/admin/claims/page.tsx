...
export default function AdminClaimsPage() {
 ...
 className="w-full md:w-auto px-8 py-3 rounded-xl bg-theme-primary text-white dark:text-theme-fg font-black text-xs uppercase tracking-widest hover:scale-105 transition-all shadow-xl"
 >
 Trigger New Cycle
 </button>
 </div>
