...
export async function GET(req: Request) {
  try {
    ...
    let query = supabase
      ...
      .select("id, title, theme, is_pinned, status, tags, last_edited_at, created_at, owner_id, owner:employees!workspace_presentations_owner_id_fkey(id,name,employee_id)")
      .eq("status", status)
