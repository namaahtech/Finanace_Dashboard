...
export default function EmployeePayslipsPage() {
 ...
 <button className="flex items-center gap-2 rounded-xl border border-default bg-background hover:bg-theme-primary dark:hover:bg-theme-raised hover:text-white dark:hover:text-theme-fg transition-all px-4 py-2 text-[10px] font-black uppercase tracking-widest text-foreground shadow-sm">
