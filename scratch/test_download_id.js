...
async function run() {
  ...
  const attachmentIds = ["1", "2", "60071733461", "1780911621123119300", "0"];

  for (const attId of attachmentIds) {
    const url = `${env.ZOHO_MAIL_API_URL}/accounts/${accountId}/folders/${folderId}/messages/${messageId}/attachments/${attId}`;
    console.log(`\n--- Fetching: ${url} ---`);
